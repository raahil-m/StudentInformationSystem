...
Problem Description: We all know how frustrating is to get around McMaster Mosaic, and to just know one simple thing it is atleast 5-6 click away. So we have created a University Student Information System which shows record of the student (info, grades, courses). These info can be displayed, modified, searched and recorded. The student will also be able to see the courses that are needed for them to graduate, and also they can swap and change courses which the program will show the timing of the open courses. 

C++ concept being used:

-functions (We will create a function that will calculate the students current gpa and final gpa in their courses.We will create a function that will calculate the final grade needed for the student to attain their inputted final grade goal. 
